...
def send_otp_email(to_email, otp):
    ...
    Requires SMTP_SERVER, SMTP_PORT, SMTP_EMAIL, SMTP_PASSWORD in env variables.
    If not configured, prints OTP to console (mock mode).
    """
    ...
    try:
        ...
        msg['From'] = smtp_email
        msg['To'] = to_email
        msg['Subject'] = "Your Chameleon Stream Login OTP"
